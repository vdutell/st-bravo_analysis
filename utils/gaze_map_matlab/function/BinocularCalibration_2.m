function CALIB = BinocularCalibration_2(LE,RE,CALIBRATION_POINTS_NUM)
...
% % % %% TEST CALIBRATION
% % % 
% % % CALIB.LE.Pzero = findZeroPupil(CALIB.LE.pupil2gaze,CALIB.LE.TARGET_PUPIL(1,:));
% % % CALIB.RE.Pzero = findZeroPupil(CALIB.RE.pupil2gaze,CALIB.RE.TARGET_PUPIL(1,:));
% % % 
% % % LEFT_GAZEzero = computeMonoGaze(CALIB.LE.Pzero,CALIB.LE);
% % % RIGHT_GAZEzero = computeMonoGaze(CALIB.RE.Pzero,CALIB.RE);
% % % 
% % % 
% % % BIN_EYE = computeFixPoint3D(LEFT_GAZEzero,RIGHT_GAZEzero,CALIB);
% % % 
% % % ERROR = norm(CENTRAL_POINT - BIN_EYE.FP);

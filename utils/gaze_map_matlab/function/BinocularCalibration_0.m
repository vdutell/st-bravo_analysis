...
CALIB.LE.pupil2gaze = compute_pupil2gaze(CALIB.LE.TARGET_PUPIL,CALIB.LE.AZ,CALIB.LE.EL);

% compute rmse
AZ_FIT = CALIB.LE.pupil2gaze.AZ(CALIB.LE.TARGET_PUPIL);
EL_FIT = CALIB.LE.pupil2gaze.EL(CALIB.LE.TARGET_PUPIL);
CALIB.LE.RMSE = sqrt(nanmean((CALIB.LE.AZ-AZ_FIT).^2 + (CALIB.LE.EL-EL_FIT).^2));
...
% fit transformation from PUPIL POSITION (x,y) to GAZE DIRECTION (AZ,EL)
CALIB.RE.pupil2gaze = compute_pupil2gaze(CALIB.RE.TARGET_PUPIL,CALIB.RE.AZ,CALIB.RE.EL);
